...
if [ ! -d ~/.df ]; then
    git clone https://github.com/AutumnMageKate/Dotfiles.git ~/.df
else
...
cp -f ~/.df/files/DefaultKeyBinding.dict ~/Library/Keybindings/DefaultKeyBinding.dict
